...
import com.proyecto.demo.modelo.dto.Tlp00002DTO;
...
super();
    ...
    private InputText txtCotizaci�nObligatoria;
    private InputText txtCotizaci�nObligatoriaArp;
    private InputText txtCodigoCentroTrabajo;
    private InputText txtCotizaci�nObligatoriaAfp;
    ...
    private InputText txtCotizaci�nObligatoriaCaja;
    private InputText txtPorcSena;
    private InputText txtCotizaci�nObligatoriaSena;
    private InputText txtPorcIcbf;
    private InputText txtCotizaci�nObligatoriaIcbf;
...
private IBusinessDelegatorView businessDelegatorView;
		...
		selectedTlp00002 = null;
             ...
             txtCodEps_Tp000003.setDisabled(true);
				   ...
				   txtIngresoBaseCotizacionSenaIcbf.setDisabled(false);	
        			    ...
        			    if(txtCotizaci�nObligatoria != null){
				   txtCotizaci�nObligatoria.setValue(null);
				   txtCotizaci�nObligatoria.setDisabled(false);	
				}
        			    if(txtCotizaci�nObligatoriaArp != null){
				   txtCotizaci�nObligatoriaArp.setValue(null);
				   txtCotizaci�nObligatoriaArp.setDisabled(false);	
				}
        			    if(txtCodigoCentroTrabajo != null){
				   txtCodigoCentroTrabajo.setValue(null);
				   txtCodigoCentroTrabajo.setDisabled(false);	
				}
        			    if(txtCotizaci�nObligatoriaAfp != null){
				   txtCotizaci�nObligatoriaAfp.setValue(null);
				   txtCotizaci�nObligatoriaAfp.setDisabled(false);	
				}
				   ...
				   txtPorcCaja.setDisabled(false);	
        			    ...
        			    if(txtCotizaci�nObligatoriaCaja != null){
				   txtCotizaci�nObligatoriaCaja.setValue(null);
				   txtCotizaci�nObligatoriaCaja.setDisabled(false);	
				}
        			    if(txtPorcSena != null){
				   txtPorcSena.setValue(null);
				   txtPorcSena.setDisabled(false);	
				}
        			    if(txtCotizaci�nObligatoriaSena != null){
				   txtCotizaci�nObligatoriaSena.setValue(null);
				   txtCotizaci�nObligatoriaSena.setDisabled(false);	
				}
        			    if(txtPorcIcbf != null){
				   txtPorcIcbf.setValue(null);
				   txtPorcIcbf.setDisabled(false);	
				}
        			    if(txtCotizaci�nObligatoriaIcbf != null){
				   txtCotizaci�nObligatoriaIcbf.setValue(null);
				   txtCotizaci�nObligatoriaIcbf.setDisabled(false);	
				}
	...
	public void listener_txtId(){
	    ...
	    try {
	    	        ...
	    	        id.setCotizaci�nObligatoria((txtCotizaci�nObligatoria.getValue())==null||(txtCotizaci�nObligatoria.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizaci�nObligatoria));
	    	        id.setCotizaci�nObligatoriaArp((txtCotizaci�nObligatoriaArp.getValue())==null||(txtCotizaci�nObligatoriaArp.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizaci�nObligatoriaArp));
	    	        ...
	    	        id.setCotizaci�nObligatoriaAfp((txtCotizaci�nObligatoriaAfp.getValue())==null||(txtCotizaci�nObligatoriaAfp.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizaci�nObligatoriaAfp));
	    	        ...
	    	        id.setCotizaci�nObligatoriaCaja((txtCotizaci�nObligatoriaCaja.getValue())==null||(txtCotizaci�nObligatoriaCaja.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizaci�nObligatoriaCaja));
	    	        id.setPorcSena((txtPorcSena.getValue())==null||(txtPorcSena.getValue()).equals("")?null: FacesUtils.checkDouble(txtPorcSena));
	    	        id.setCotizaci�nObligatoriaSena((txtCotizaci�nObligatoriaSena.getValue())==null||(txtCotizaci�nObligatoriaSena.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizaci�nObligatoriaSena));
	    	        id.setPorcIcbf((txtPorcIcbf.getValue())==null||(txtPorcIcbf.getValue()).equals("")?null: FacesUtils.checkDouble(txtPorcIcbf));
	    	        id.setCotizaci�nObligatoriaIcbf((txtCotizaci�nObligatoriaIcbf.getValue())==null||(txtCotizaci�nObligatoriaIcbf.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizaci�nObligatoriaIcbf));
		...
		if(entity==null){
	    	        ...
	    	        txtCodUsuario.setDisabled(false);
		    		        ...
		    		        txtCotizaci�nObligatoria.setValue(entity.getId().getCotizaci�nObligatoria());txtCotizaci�nObligatoria.setDisabled(true);
		    		        txtCotizaci�nObligatoriaArp.setValue(entity.getId().getCotizaci�nObligatoriaArp());txtCotizaci�nObligatoriaArp.setDisabled(true);
		    		        txtCodigoCentroTrabajo.setValue(entity.getId().getCodigoCentroTrabajo());txtCodigoCentroTrabajo.setDisabled(true);
		    		        txtCotizaci�nObligatoriaAfp.setValue(entity.getId().getCotizaci�nObligatoriaAfp());txtCotizaci�nObligatoriaAfp.setDisabled(true);
		    		        ...
		    		        txtCotizaci�nObligatoriaCaja.setValue(entity.getId().getCotizaci�nObligatoriaCaja());txtCotizaci�nObligatoriaCaja.setDisabled(true);
		    		        txtPorcSena.setValue(entity.getId().getPorcSena());txtPorcSena.setDisabled(true);
		    		        txtCotizaci�nObligatoriaSena.setValue(entity.getId().getCotizaci�nObligatoriaSena());txtCotizaci�nObligatoriaSena.setDisabled(true);
		    		        txtPorcIcbf.setValue(entity.getId().getPorcIcbf());txtPorcIcbf.setDisabled(true);
		    		        txtCotizaci�nObligatoriaIcbf.setValue(entity.getId().getCotizaci�nObligatoriaIcbf());txtCotizaci�nObligatoriaIcbf.setDisabled(true);
	...
	public String action_edit(ActionEvent evt){
    	...
    	selectedTlp00002 = (Tlp00002DTO)(evt.getComponent().getAttributes().get("selectedTlp00002"));		
            ...
            txtCotizaci�nObligatoria.setValue(selectedTlp00002.getCotizaci�nObligatoria());txtCotizaci�nObligatoria.setDisabled(true);
            txtCotizaci�nObligatoriaArp.setValue(selectedTlp00002.getCotizaci�nObligatoriaArp());txtCotizaci�nObligatoriaArp.setDisabled(true);
            txtCodigoCentroTrabajo.setValue(selectedTlp00002.getCodigoCentroTrabajo());txtCodigoCentroTrabajo.setDisabled(true);
            txtCotizaci�nObligatoriaAfp.setValue(selectedTlp00002.getCotizaci�nObligatoriaAfp());txtCotizaci�nObligatoriaAfp.setDisabled(true);
            ...
            txtCotizaci�nObligatoriaCaja.setValue(selectedTlp00002.getCotizaci�nObligatoriaCaja());txtCotizaci�nObligatoriaCaja.setDisabled(true);
            txtPorcSena.setValue(selectedTlp00002.getPorcSena());txtPorcSena.setDisabled(true);
            txtCotizaci�nObligatoriaSena.setValue(selectedTlp00002.getCotizaci�nObligatoriaSena());txtCotizaci�nObligatoriaSena.setDisabled(true);
            txtPorcIcbf.setValue(selectedTlp00002.getPorcIcbf());txtPorcIcbf.setDisabled(true);
            txtCotizaci�nObligatoriaIcbf.setValue(selectedTlp00002.getCotizaci�nObligatoriaIcbf());txtCotizaci�nObligatoriaIcbf.setDisabled(true);
	...
	public String action_modify() {
        try {
        	if(entity==null){
		    		        ...
		    		        id.setCotizaci�nObligatoria(selectedTlp00002.getCotizaci�nObligatoria());
		    		        id.setCotizaci�nObligatoriaArp(selectedTlp00002.getCotizaci�nObligatoriaArp());
		    		        id.setCodigoCentroTrabajo(selectedTlp00002.getCodigoCentroTrabajo());
		    		        id.setCotizaci�nObligatoriaAfp(selectedTlp00002.getCotizaci�nObligatoriaAfp());
		    		        ...
		    		        id.setCotizaci�nObligatoriaCaja(selectedTlp00002.getCotizaci�nObligatoriaCaja());
		    		        id.setPorcSena(selectedTlp00002.getPorcSena());
		    		        id.setCotizaci�nObligatoriaSena(selectedTlp00002.getCotizaci�nObligatoriaSena());
		    		        id.setPorcIcbf(selectedTlp00002.getPorcIcbf());
		    		        id.setCotizaci�nObligatoriaIcbf(selectedTlp00002.getCotizaci�nObligatoriaIcbf());
    ...
    public String action_closeDialog(){
        ...
        public String action_modifyWitDTO(String numPlanilla, String codiEps, String codiArp, String codiAfp, String codiCaja, String cotizante, String codEmpresaEmp, String ciuLaboralCotizante, String depLaboralCotizante, String tipocotizante, String subTipocotizante, Integer diasCotizados, Integer diasCotizadosArp, Integer diasCotizadosAfp, Integer diasCotizadosCaja, Double salarioBasico, String salarioCIntegral, String planillaEps, String planillaArp, String planillaAfp, String planillaCaja, String numAuincapacidad, Double valorIncapacidad, String numAulicenciaM, Double valorLicenciaM, Double valorUpcAdicional, Double ingresoBaseCotizacion, Double ingresoBaseCotizacionArp, Double ingresoBaseCotizacionAfp, Double ingresoBaseCotizacionCaja, Double ingresoBaseCotizacionSenaIcbf, Double cotizaci�nObligatoria, Double cotizaci�nObligatoriaArp, String codigoCentroTrabajo, Double cotizaci�nObligatoriaAfp, Double valorFpsolidaridad, Double valorFpsubsistencia, Integer riesgos, Double porcEps, Double porcRiesgo, Double porcAfp, Double porcCaja, Double cotizaci�nObligatoriaCaja, Double porcSena, Double cotizaci�nObligatoriaSena, Double porcIcbf, Double cotizaci�nObligatoriaIcbf, String detaPlanPrimeraEps, String detaPlanPrimeraArp, String detaPlanPrimeraAfp, String detaPlanPrimeraCaja, String ing, String ret, String tde, String tae, String codiEpsTraslado, String tdp, String tap, String codiAfpTraslado, String tda, String taa, String vsp, String vte, String vst, String sln, String ige, String lma, String vac, String avp, String vct, String irp, String codUsuario, String codEps_Tp000003) throws Exception {
        try {
        ...
        return "";
                                                ...
                                                this.txtIngresoBaseCotizacionSenaIcbf = txtIngresoBaseCotizacionSenaIcbf;
                                                                                            ...
                                                                                            public InputText getTxtCotizaci�nObligatoria() {
                                                return txtCotizaci�nObligatoria;
                                                }
                                                public void setTxtCotizaci�nObligatoria(InputText txtCotizaci�nObligatoria) {
                                                this.txtCotizaci�nObligatoria = txtCotizaci�nObligatoria;
                                                }
                                                                                            public InputText getTxtCotizaci�nObligatoriaArp() {
                                                return txtCotizaci�nObligatoriaArp;
                                                }
                                                public void setTxtCotizaci�nObligatoriaArp(InputText txtCotizaci�nObligatoriaArp) {
                                                this.txtCotizaci�nObligatoriaArp = txtCotizaci�nObligatoriaArp;
                                                }
                                                ...
                                                this.txtCodigoCentroTrabajo = txtCodigoCentroTrabajo;
                                                                                            ...
                                                                                            public InputText getTxtCotizaci�nObligatoriaAfp() {
                                                return txtCotizaci�nObligatoriaAfp;
                                                }
                                                public void setTxtCotizaci�nObligatoriaAfp(InputText txtCotizaci�nObligatoriaAfp) {
                                                this.txtCotizaci�nObligatoriaAfp = txtCotizaci�nObligatoriaAfp;
                                                }
                                                ...
                                                this.txtPorcCaja = txtPorcCaja;
                                                                                            ...
                                                                                            public InputText getTxtCotizaci�nObligatoriaCaja() {
                                                return txtCotizaci�nObligatoriaCaja;
                                                }
                                                public void setTxtCotizaci�nObligatoriaCaja(InputText txtCotizaci�nObligatoriaCaja) {
                                                this.txtCotizaci�nObligatoriaCaja = txtCotizaci�nObligatoriaCaja;
                                                }
                                                ...
                                                this.txtPorcSena = txtPorcSena;
                                                                                            ...
                                                                                            public InputText getTxtCotizaci�nObligatoriaSena() {
                                                return txtCotizaci�nObligatoriaSena;
                                                }
                                                public void setTxtCotizaci�nObligatoriaSena(InputText txtCotizaci�nObligatoriaSena) {
                                                this.txtCotizaci�nObligatoriaSena = txtCotizaci�nObligatoriaSena;
                                                }
                                                ...
                                                this.txtPorcIcbf = txtPorcIcbf;
                                                                                            ...
                                                                                            public InputText getTxtCotizaci�nObligatoriaIcbf() {
                                                return txtCotizaci�nObligatoriaIcbf;
                                                }
                                                public void setTxtCotizaci�nObligatoriaIcbf(InputText txtCotizaci�nObligatoriaIcbf) {
                                                this.txtCotizaci�nObligatoriaIcbf = txtCotizaci�nObligatoriaIcbf;
                                                }
